(() => {
    ...
    window.addEventListener("DOMContentLoaded", (function(e) {
        const titleFirst = document.querySelector(".main__title_first");
        const titleSecond = document.querySelector(".main__title_second");
        const btnMain = document.querySelector(".main__button");
        setTimeout((() => {
            titleFirst.classList.add("_active");
        }), "500");
        setTimeout((() => {
            titleSecond.classList.add("_active");
        }), "2000");
        setTimeout((() => {
            btnMain.classList.add("_active");
        }), "4400");
        if (!isMobile.any() && document.querySelector(".teachers__items").classList.contains("_click-icon")) document.querySelector(".teachers__items").classList.remove("_click-icon");
        if (isMobile.any()) document.querySelector(".teachers__items").classList.add("_click-icon");
        document.addEventListener("click", documentActions);
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".card-directions__body")) targetElement.closest(".card-directions__body").classList.toggle("_show");
            if (targetElement.closest(".item-teachers__body") || targetElement.closest(".item-teachers__click-pointer") || targetElement.closest(".item-teachers__window")) if (isMobile.any()) targetElement.closest(".teachers__item").classList.toggle("_show-card");
            if (isMobile.any()) if (targetElement.closest(".item-price")) {
                if (document.querySelector("._active-price")) {
                    document.querySelector("._active-price").classList.remove("_active-price");
                    targetElement.closest(".item-price").classList.add("_active-price");
                }
                targetElement.closest(".item-price").classList.add("_active-price");
            }
            if (targetElement.closest(".schedule__button")) {
                if (selectsIndex.age === 0 && selectsIndex.style === 0) document.getElementById("hop_adult").classList.add("_active-img");
                if (selectsIndex.age === 0 && selectsIndex.style === 1) document.getElementById("house_adult").classList.add("_active-img");
                if (selectsIndex.age === 1 && selectsIndex.style === 0) document.getElementById("hop_kids").classList.add("_active-img");
                if (selectsIndex.age === 1 && selectsIndex.style === 1) document.getElementById("house_kids").classList.add("_active-img");
            }
        }
        const selectsIndex = {
            age: 0,
        ...
        document.addEventListener("selectCallback", (function(e) {
            const currentForm = e.detail.select;
            const selectOptionIndex = e.detail.select.selectedIndex;
            if (document.querySelector("._active-img")) document.querySelector("._active-img").classList.remove("_active-img");
            if (currentForm.closest(".schedule__form-age")) selectsIndex.age = selectOptionIndex;
            if (currentForm.closest(".schedule__form-styles")) selectsIndex.style = selectOptionIndex;
        }));
    }));
    window["FLS"] = true;
    isWebp();
